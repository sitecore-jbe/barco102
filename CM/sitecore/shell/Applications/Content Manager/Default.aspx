...
<body runat="server" id="Body" class="scWindowBorder1 contentEditor" onmousedown="javascript:scWin.mouseDown(this, event)"
    ...
    <form id="ContentEditorForm" style="overflow: hidden" runat="server">
            <sc:CodeBeside runat="server" Type="Sitecore.SalesEngineers.Demo.Extensions.CultureVersions.Shell.Applications.ContentManager.ContentEditorForm, Sitecore.SalesEngineers.Demo.Extensions.CultureVersions" />
